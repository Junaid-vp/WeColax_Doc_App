      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-3xl p-6 h-fit">
           ...
           <form className="space-y-4">
             <input type="password" placeholder="Current Password" required className="w-full bg-slate-50 border border-slate-200 rounded-xl py-2 px-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all shadow-sm" />
             <input type="password" placeholder="New Password" required className="w-full bg-slate-50 border border-slate-200 rounded-xl py-2 px-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all shadow-sm" />
             <button type="button" className="px-4 py-2 bg-purple-600 rounded-lg text-white font-medium hover:bg-purple-700 shadow-md shadow-purple-600/20 transition-all active:scale-95">Update Password</button>
           </form>
        </div>
