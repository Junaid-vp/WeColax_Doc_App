          ...
          {influencers.map(inf => (
            <div key={inf.id} className="bg-white border border-slate-200 rounded-3xl p-6 hover:shadow-md transition-shadow group shadow-sm">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-bold text-slate-900 group-hover:text-pink-600 transition-colors">{inf.name}</h3>
                <span className="text-[10px] uppercase tracking-wider text-slate-500 flex items-center gap-1 bg-slate-100 px-2 py-1 rounded-lg border border-slate-200 shrink-0">
